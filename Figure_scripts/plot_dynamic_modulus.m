...
x1 = Wavelength;
y1 = Average_spectrums(97,:) ; % 2.49MPa
y2 = Average_spectrums(68,:) ; % 1.77MPa
y3 = Average_spectrums(191,:) ;% 1.3 MPa
...
%grid on
lg = legend('2.49MPa','1.77MPa','1.3 MPa','Location','northeast','fontsize', 14);
title(lg,'Thickness')
set(lg, 'EdgeColor', 'w')
title(lg,'Thickness')
xlim([700 1050])
