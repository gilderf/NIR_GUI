...
for ii=1:KFold
    ...
    yfit_PLS_JK(ind_predict) = [ones(numel(ind_predict),1) X(ind_predict,selected_variables)]*betaPLS;

end

% we can plot the result
figure
scatter(Y,yfit_PLS_JK)
title(num2str(corr(Y,yfit_PLS_JK)))