...
%  Lars Nørgaard, February 2000; bug fixed March 2013
%
...
elseif strcmp(labeltype,'wavlabel')
   ...
   Xint  = [Model.xaxislabels(a)' Model.xaxislabels(a)' Model.xaxislabels(b)' Model.xaxislabels(b)']';
...
hold on
for i=1:No_of_PCs
   horzline(Model.PCAmodel{Model.intervals+1}.varexp(i,3),'-b') % Subfunction
end
axis tight;
actualaxis=axis;
